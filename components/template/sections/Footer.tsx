...
type FooterProps = LMContent['footer']

const SOCIAL_SVGS: Record<'instagram' | 'facebook' | 'whatsapp', ReactElement> = {
  instagram: (
...
const SOCIAL_LABELS: Record<'instagram' | 'facebook' | 'whatsapp', string> = {
  instagram: 'Instagram',
  facebook:  'Facebook',
  whatsapp:  'WhatsApp',
}

export function Footer({ logo, nav, social, contact, legalLine }: FooterProps) {
  return (
    <footer className="bg-navy text-white">
      <div className="max-w-[940px] mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Logo */}
          <div>
            <Image src={logo} alt="A&J Real Estate Group" width={140} height={48} className="mb-4" />
          </div>
